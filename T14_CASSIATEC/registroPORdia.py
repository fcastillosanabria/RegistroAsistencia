        ...
        while True:
            ...
            for obj in decoded_objects:
                ...
                if data in qr_registrados:
                    ...
                    datos.append(datetime.now().strftime('%I:%M:%S %p %d-%m-%Y'))
                    ...
                    if os.path.isfile(nombre_archivo):
                        ...
                        ws.append(["Apellido", "Nombre", "Grado", "Seccion", "Turno", "Hora y Fecha"])
            ...
            cv2.putText(frame, "Escanea QR!", (120, 450), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3, cv2.LINE_AA)
