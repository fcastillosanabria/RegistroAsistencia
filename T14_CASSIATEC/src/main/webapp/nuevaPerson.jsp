...
<body
	...
	<!--	<div class="container bg-white p-5 rounded-5 text-secondary shadow"
		...
		<form>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mb-3">
					<label for="Sexo" class="form-label fw-bold fs-4 text-dark">Nacimiento</label>
					<input type="text"
						class="form-control input-custom placeholder-black"
						id="Fecha de nacimiento" placeholder="Ingrese su nacimiento">
				</div>
			</div>
	...
	<div
		...
		<div class="card-body">
			...
			<h2 class="text-center mt-6 text-dark">Agregar Person</h2>
			...
			<form>
				...
				<div class="row">
					<div class="col-6 mb-3">
						<label for="Telefono" class="form-label fw-bold fs-5 text-dark">Telefono:</label>
						<input type="text"
							class="form-control input-custom placeholder-black" id="Telefono"
							placeholder="Ingrese su Telefono">
					</div>
